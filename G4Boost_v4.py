...
parser.add_argument('--classifier',
                   required= False,
                   default= 'xgb_classification_tuned_model_1.sav',
                   help='''Use specified classifier (G4Boost_classifier.sav)
                   ''')
parser.add_argument('--regressor',
                   required= False,
                   default= 'xgb_regression_tuned_model_2.sav',
...
selected='length len maxgstem maxgbase maxlbase minlbase G C GG CC'.split(' ')
